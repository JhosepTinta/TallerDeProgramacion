...
public class PantallaAlarma extends JPanel {
	...
	//En esta parte del código estamos poniendo los botones lo es la parte del 
	//interfaz donde el usuario va apreciar en el controlador.
	
	//Aquí están los textos los Jlabel.
	...
	//Inicialización de las clases creado para la Alarma
	
	AlertaAlarma v = new AlertaAlarma();
	ListaDeAlarmas lista = new ListaDeAlarmas();
	
	//Este inicialización nos permite agregar en JlList.
...
//		En esta parte se lo que seria JList  dentro del JScrollPane.
	...
	//En esta parte están los texto que van aparecer en pantalla de alarma.
		...
		//Aquí se esta poniendo el botón para poner si es AM o PM.
		...
		//En esta parte estamos aceptando la Alarma ingresda o el botón de programar alarma.
		...
		//En aquí esta el botón para eliminar o desprogramar la Alarma
		...
		//Aquí es el botón para eliminar todo las Alarmas Programadas.
	...
	//Aquí estamos añadiendo para que se haga visible.
