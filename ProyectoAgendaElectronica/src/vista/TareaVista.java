...
//En este parte del código  para Tarea Pendiente  se ponen los botones, textos y entre otros 
//componentes en Jpanel que se va mostrar en la visualización de la pantalla.

public class TareaVista extends JPanel {

	//aquí tenemos los atributos de las cosas que vamos necesitar para crear nuestro JPanel.
...
//NUEVOS BOTONES
	...
	public TareaVista() {
		...
		//En el constructor del código tenemos la parte letras  y el formato o color también los textos de componentes.
...
//NUEVOS BOTONES
		...
		//Aquí estamos agregando el método que se creó de Agregar Elementos.
	...
	{
		//En esta parte del código no esta devolviendo el tamaño de los componentes y que lo estamos añadiendo en JPanel.
	...
	//NUEVOS BOTONES 	
		...
		// En esta parte estamos añadiendo los botones o textos en la pantalla o que sea visible.
   ...
   //NUEVOS BOTONES
	...
	//Esta parte es muy importe es un método donde estamos guardando los botones de vista en 
	//el controlador para que cumpla la acción de presionar esos botones.
